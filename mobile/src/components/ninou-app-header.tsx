  ...
  return (
    <View style={[styles.header, { backgroundColor: colors.surface, borderColor: colors.border }]}>
      ...
      <Pressable accessibilityRole="button" accessibilityLabel="Abrir menu do avatar" onPress={() => setMenuOpen(true)} style={styles.identity}>
        <View style={[styles.avatarFrame, { borderColor: isDark ? 'rgba(255,255,255,0.14)' : 'rgba(255,255,255,0.9)', backgroundColor: colors.primarySoft }]}><AvatarArt avatarId={profile.avatarId} size={42} rounded /><View style={[styles.avatarStatus, { backgroundColor: colors.accent, borderColor: colors.surface }]} /></View>
