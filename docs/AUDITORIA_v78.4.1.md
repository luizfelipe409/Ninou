# Auditoria técnica — Ninou v81.0.0

## Escopo desta correção

A v81.0.0 foi criada a partir da gravação de 13/07/2026, com foco nos três defeitos confirmados em aparelho móvel:
...
- módulo `js/runtime/visual-guard-v81.0.0.mjs`, que mede a geometria renderizada e reaplica a composição quando necessário;
