# Auditoria técnica — Ninou v80.1.4

## Escopo desta correção

A v80.1.4 foi criada a partir da gravação de 13/07/2026, com foco nos três defeitos confirmados em aparelho móvel:
...
- módulo `js/runtime/visual-guard-v80.1.4.mjs`, que mede a geometria renderizada e reaplica a composição quando necessário;
