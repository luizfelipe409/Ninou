# Auditoria técnica — Ninou v82.0.3

## Escopo desta correção

A v82.0.3 foi criada a partir da gravação de 13/07/2026, com foco nos três defeitos confirmados em aparelho móvel:
...
- módulo `js/runtime/visual-guard-v82.0.3.mjs`, que mede a geometria renderizada e reaplica a composição quando necessário;
