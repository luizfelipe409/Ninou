# Firestore Rules — Ninou v75.27

Compatível com criação de novas famílias/clientes pelo admin, convites por família selecionada e acesso administrativo como suporte global.
...
service cloud.firestore {
  match /databases/{database}/documents {
    ...
    /*
      Permissões para collectionGroup usadas na busca inteligente da v75.21.
...
Observação v75.27: o admin global acessa famílias como suporte pelo e-mail administrador, sem precisar existir em `families/{familyId}/members`.
