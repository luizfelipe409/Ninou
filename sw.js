const APP_VERSION = "83.0.2";
const CACHE_NAME = `ninou-${APP_VERSION}-launch`;

const APP_SHELL = [
  "/", "/index.html",
  `/styles/app.css?v=${APP_VERSION}`,
  `/js/bootstrap.mjs?v=${APP_VERSION}`,
  `/js/app-core.mjs?v=${APP_VERSION}`,
  `/js/ui/app-shell.mjs?v=${APP_VERSION}`,
  `/js/ui/ux-runtime.mjs?v=${APP_VERSION}`,
  `/js/ui/consistency-runtime.mjs?v=${APP_VERSION}`,
  `/js/runtime/architecture.mjs?v=${APP_VERSION}`,
  `/js/runtime/stability.mjs?v=${APP_VERSION}`,
  `/js/runtime/diagnostics.mjs?v=${APP_VERSION}`,
  `/js/runtime/visual-guard.mjs?v=${APP_VERSION}`,
  ...
  "/js/domain/event-editor.js", "/js/domain/baby-profile.js", "/js/domain/weights.js", "/js/domain/sounds.js",
  "/js/services/firebase-service.js", "/js/services/commercial-access-service.js", "/js/services/account-service.js",
