...
assert.match(html, /styles\/legacy\.css\?v=82\.1\.4/);
assert.doesNotMatch(html, /styles\/admin-v82\.0\.0\.css/);
assert.doesNotMatch(html, /js\/ninou-admin-v82\.0\.0\.mjs/);
assert.match(html, /styles\/premium-v82\.0\.0\.css\?v=82\.1\.4/);
assert.match(html, /styles\/focused-flow-v82\.0\.0\.css\?v=82\.1\.4/);
assert.doesNotMatch(html, /styles\/(tokens|foundation|home|components|motion|responsive|v78\.4-critical)\.css/);
assert.match(html, /boot-v82\.0\.0\.mjs\?v=82\.1\.4/);
assert.match(html, /__NINOU_BOOT_WATCHDOG__/);
assert.match(html, /history\.replaceState/);

assert.match(boot, /const NINOU_VERSION = "82\.1\.4"/);
assert.match(boot, /const MIN_SPLASH_MS = 1500;/);
assert.match(boot, /visual-guard-v82\.0\.0/);
assert.match(core, /const NINOU_RUNTIME_VERSION = "82\.1\.4"/);
assert.match(core, /const NINOU_FAMILY_SCOPE_VERSION = "82\.1\.4-admin-responsive-clean"/);
assert.match(core, /const ADMIN_STYLESHEET_HREF = "\.\/styles\/admin-mobile-parity-v82\.1\.1\.css\?v=82\.1\.4"/);
assert.match(core, /const ADMIN_RUNTIME_HREF = "\.\/ninou-admin-v82\.0\.0\.mjs\?v=82\.1\.4"/);
...
assert.match(adminRuntime, /admin-service\.js\?v=82\.1\.4/);
...
assert.match(sw, /ninou-v82-1-4-web-admin-gate/);
assert.match(sw, /ninou-admin-v82\.0\.0\.mjs\?v=\$\{APP_VERSION\}/);
assert.match(sw, /const APP_VERSION = "82\.1\.4"/);
