...
const failures = [];
const cssModules = ["legacy", "tokens", "foundation", "home", "components", "motion", "responsive", "v78.4-critical"];
const required = [
...
if (premiumImportant > 1100) failures.push(`Camada premium usa !important em excesso: ${premiumImportant}`);
