...
const NINOU_RUNTIME_VERSION = "78.3.0";
...
function prepareVisibleContextForAccount(user = cloudUser) {
  ...
  /*
    v78.3.0 — retomada sem tela fantasma:
...
if ("serviceWorker" in navigator) {
  ...
  window.addEventListener("load", () => {
    navigator.serviceWorker.register("/sw.js?v=78.3.0", { updateViaCache: "none" }).then((registration) => {
