...
export function getFirebaseErrorMessage(error) {
  ...
  const messages = {
    ...
    "auth/operation-not-allowed": "O acesso por e-mail e senha está temporariamente indisponível.",
    "auth/too-many-requests": "Muitas tentativas em pouco tempo. Aguarde alguns minutos e tente novamente.",
    "auth/user-disabled": "Esta conta está desativada. Fale com o atendimento Ninou.",
