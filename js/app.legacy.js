...
const NINOU_RUNTIME_VERSION = "75.73.3";
...
function renderAvatarEditorVisibility() {
  ...
  // v75.73.3: a seleção de avatares virou modal, aberto apenas pelo botão Editar.
  if (babyAvatarCard) {
...
function updateGuestWhatsappButton() {
  ...
  // v75.73.3: o atalho flutuante estava poluindo a tela e aparecendo em contextos indevidos.
...
async function connectCurrentAccount() {
  /*
    v75.73.3 — login rápido, mas consistente:
